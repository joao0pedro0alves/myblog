...
export function SupportSection() {
  return (
    <section className="pb-8 py-2 md:py-10 md:mt-28 bg-gradient-to-r from-gray-600 to-gray-700 bg-[url('/assets/support-section-background.png')] bg-cover bg-center bg-gray-700">
